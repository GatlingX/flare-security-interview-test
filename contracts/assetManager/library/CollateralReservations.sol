...
library CollateralReservations {
        ...
        internal
    {
        ...
        require(_rejectedRequest != address(0), "rejected request cannot be zero address");
        ...
        cr.rejectedRequest = _rejectedRequest;
        ...
        private
    {
        ...
        if (returnFee > 0) {
            Globals.getWNat().depositTo{value: returnFee}(crt.rejectedRequest);
        }
