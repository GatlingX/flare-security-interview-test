...
contract CollateralReservationsFacet is AssetManagerBase, ReentrancyGuard {
     ...
     * @param _rejectedRequest the address that will receive collateral reservation fee if the request is rejected
        ...
        nonReentrant
    {
        CollateralReservations.reserveCollateral(msg.sender, _agentVault,
            _lots.toUint64(), _maxMintingFeeBIPS.toUint64(), _executor, _rejectedRequest, _minterUnderlyingAddresses);
    }
